...
use crate::transaction::{Transaction, TxOutput, TxError};
use crate::address::Address;
use crate::difficulty::{Difficulty, TARGET_BLOCK_TIME, DIFFICULTY_AVERAGING_WINDOW};
...
mod tests {
    ...
    fn test_reward_halving() {
        ...
        assert_eq!(Blockchain::reward_for_height(HALVING_INTERVAL), GENESIS_REWARD / 2);
        assert_eq!(Blockchain::reward_for_height(HALVING_INTERVAL * 2), GENESIS_REWARD / 4);
    }
