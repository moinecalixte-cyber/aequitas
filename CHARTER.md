# ⚖️ The Aequitas Charter (Chartre Fondatrice)
...
Aequitas is a **Stablecoin by Nature**, not by Peg.
*   **Fiat Independence**: Unlike "stable" coins indexed to USD or EUR (which lose value to inflation), Aequitas is indexed only to the mathematical difficulty of its production.
*   **Universal Value**: Because it is not tied to any failing currency, Aequitas maintains an **absolute value anchor** in the digital realm. It cannot lose value to external monetary shifts.
...
The code is the law.
*   The entire supply and every transaction is publicly auditable.
*   No hidden minting, no backdoor access, no inflation beyond the 210M hard cap.

## 5. Global Decentralization
*   Aequitas has no center. It exists everywhere the Kademlia DHT reaches.
*   The network is designed to survive global internet disruptions through peer-to-peer resilience.

---
*By running an Aequitas Node, you agree to uphold and defend this Charter.*
